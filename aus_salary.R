...
plot1 <- left_join(top.10.female, all.male, by = "occupation") %>% 
      ...
      coord_flip() + 
      ggtitle("Top 10 Highest Income Occupations for Females in Austrailia [pink]", 
              subtitle = "Comparison of Male Counterpart Salaries [blue]") +
      labs(x = NULL, 
           y = "Average Income (100K$)", 
...
# ---------- Top 10 Highest Income Occupations for Males in Austrailia --------
